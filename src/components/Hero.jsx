...
const Hero = () => {
    return <section name="home" className="w-full bg-zinc-200 flex flex-col justify-between py-7">
        <div className="m-auto grid md:grid-cols-2 px-7 py-7">
            <div className="flex flex-col justify-center md:items-start w-[100%] px-4 py-8">
                ...
                <button className="w-full py-2 px-5 my-3 text-white border bg-indigo-600 border-indigo-600
    hover:bg-transparent hover:text-indigo-600 rounded-md ">Get Started</button>
        ...
        <div className="w-[80%] bg-gray-100 border-slate-300 rounded-xl mx-auto px-5 text-center shadow-xl mt-[-1rem] py-7">
                <p className="text-center text-2xl font-bold text-zinc-900 tracking-widest">Data services</p>
                <div className="grid grid-cols-2 md:grid-cols-4 py-2 mt-4 md:justify-between">
                    <p className="flex mb-3 font-medium"><CloudUploadIcon className="h-6 text-indigo-600 mr-3" />App security</p>
                    <p className="flex mb-3 font-medium"><MailOpenIcon className="h-6 text-indigo-600 mr-3" />Mail Service</p>
